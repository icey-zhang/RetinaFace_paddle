...
parser.add_argument('--dataset_folder', default='/home/data2/zhangjiaqing/widerface/val/images/', type=str, help='dataset path')
...
if __name__ == '__main__':
    ...
    testset_list = args.dataset_folder[:-7] + "val.txt" #"wider_val.txt" zjq
    ...
    # for i,nameandimg in enumerate(test_dataloader()):
        ...
        # img =nameandimg[1].cuda()
        # scale = paddle.to_tensor([img.shape[1], img.shape[0], img.shape[1], img.shape[0]])
        # img_name =nameandimg[0][0]
        # resize = nameandimg[2]
        # img_raw = nameandimg[3].squeeze().cpu().numpy()
