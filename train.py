...
parser.add_argument('--training_dataset', default='/home/data2/zhangjiaqing/widerface/train/label.txt', help='Training dataset directory')
...
def train():
    ...
    train_dataloader =paddle.io.DataLoader(dataset, batch_size=batch_size, shuffle=True, num_workers=num_workers, collate_fn=detection_collate)
    ...
    # for iteration in range(start_iter, max_iter):
        # if iteration % epoch_size == 0:
            #batch_iterator._reader.shutdown()
            # create batch iterator
            # batch_iterator =iter(paddle.io.DataLoader(dataset, batch_size, shuffle=True, num_workers=num_workers, collate_fn=detection_collate))
            ...
            print('Epoch:{}/{} || Epochiter: {}/{} || Iter: {}/{} || Loc: {:.4f} Cla: {:.4f} Landm: {:.4f} || Batchtime: {:.4f} s || ETA: {}'
                ...
                epoch_size, epoch_size * epoch + iteration + 1, max_iter, loss_l.item(), loss_c.item(), loss_landm.item(), batch_time, str(datetime.timedelta(seconds=eta))))
